...
static const yytype_uint8 yyprhs[] =
{
      ...
      45,    48,    51,    54,    56,    59,    62,    65,    68,    71,
      74,    76,    78,    81,    84,    86,    89,    92,    95,    98,
...
{
      43,     0,    -1,    -1,    43,    45,    -1,    44,     9,    -1,
       9,    -1,    49,    44,    -1,    49,    46,    -1,    49,    47,
      -1,    49,    48,    -1,    49,    -1,     7,    -1,     8,    -1,
      25,    -1,    26,    -1,    27,    -1,    28,    -1,     6,    -1,
      12,     9,    -1,     3,    -1,     4,     9,    -1,     5,     9,
      -1,    10,    18,    -1,    13,    -1,    14,     9,    -1,    15,
       9,    -1,    16,     9,    -1,    17,    18,    -1,    20,     9,
      -1,    21,     9,    -1,    22,    -1,    23,    -1,    24,     9,
      -1,    19,    18,    -1,    29,    -1,    30,     9,    -1,    31,
       9,    -1,    32,    18,    -1,    34,    33,    -1,    34,    36,
      -1,    34,    37,    -1,    35,    -1,    39,     9,    -1,    40,
       9,    -1,    38,    -1,    41,    18,    -1
};
...
{
       0,    23,    23,    24,    27,    29,    32,    34,    36,    38,
      40,    43,    45,    48,    50,    53,    55,    58,    59,    60,
      61,    62,    63,    79,    80,    81,    82,    83,    99,   100,
     101,   102,   103,   104,   110,   111,   112,   113,   129,   135,
     141,   147,   148,   149,   150,   151
};
#endif
...
{
  "$end", "error", "$undefined", "AM_SOURCE", "AM_DEPTH", "AM_FREQ",
  "AM_FREQ1", "INTERNAL", "EXTERNAL", "NUMBER", "START", "VIRGULA",
  "VOLTAGE", "FM_SOURCE", "FM_FREQ", "FM_PEAK", "FREQ", "FM_START", "OK",
  "SW_START", "SW_FR_START", "SW_FR_STOP", "SW_LIN_LOG", "SW_UP_DOWN",
  "SW_TIME", "LINEAR", "LOGARITHMIC", "SW_UP", "SW_DOWN", "PM_SOURCE",
  "PM_FREQ", "PM_DEVIATION", "PM_START", "SINUSOID", "FUNCTION", "TRIGGER",
  "NOISE", "TRIANGLE", "FSK_SOURCE", "FSK_MARK", "FSK_SPACE", "FSK_START",
  "$accept", "commands", "numbers", "command", "sursa", "spacing",
  "direct", "comm", 0
};
#endif
...
{
       2,     0,     1,    19,     0,     0,    17,     0,     0,    23,
       0,     0,     0,     0,     0,     0,     0,    30,    31,     0,
      34,     0,     0,     0,     0,    41,    44,     0,     0,     0,
       3,    10,    20,    21,    22,    18,    24,    25,    26,    27,
      33,    28,    29,    32,    35,    36,    37,    38,    39,    40,
      42,    43,    45,    11,    12,     5,    13,    14,    15,    16,
       6,     7,     8,     9,     4
};
...
{
     -12,     0,   -12,   -12,    -8,    -7,   -12,   -11,    -1,   -12,
       2,     9,    19,    -9,    15,    27,    28,   -12,   -12,    33,
     -12,    39,    40,    34,    14,   -12,   -12,    44,    45,    37,
...
{
       2,    32,    33,     3,     4,     5,     6,    34,    35,    39,
       7,    36,     8,     9,    10,    11,    12,    13,    37,    14,
      15,    16,    17,    18,    19,    53,    54,    55,    38,    20,
      21,    22,    23,    40,    24,    25,    41,    42,    26,    27,
      28,    29,    43,    56,    57,    58,    59,    47,    44,    45,
      48,    49,    46,    50,    51,    52,    64
};

static const yytype_uint8 yycheck[] =
{
       0,     9,     9,     3,     4,     5,     6,    18,     9,    18,
      10,     9,    12,    13,    14,    15,    16,    17,     9,    19,
      20,    21,    22,    23,    24,     7,     8,     9,     9,    29,
      30,    31,    32,    18,    34,    35,     9,     9,    38,    39,
      40,    41,     9,    25,    26,    27,    28,    33,     9,     9,
      36,    37,    18,     9,     9,    18,     9
};
...
{
       0,    43,     0,     3,     4,     5,     6,    10,    12,    13,
      14,    15,    16,    17,    19,    20,    21,    22,    23,    24,
      29,    30,    31,    32,    34,    35,    38,    39,    40,    41,
      45,    49,     9,     9,    18,     9,     9,     9,     9,    18,
      18,     9,     9,     9,     9,     9,    18,    33,    36,    37,
       9,     9,    18,     7,     8,     9,    25,    26,    27,    28,
      44,    46,    47,    48,     9
};
...
/* Line 1455 of yacc.c  */
#line 61 "test.y"
    {printf("  >>percentage modulation: %i\n",(yyvsp[(2) - (2)]));depth=(yyvsp[(2) - (2)]);}
    break;
...
/* Line 1455 of yacc.c  */
#line 62 "test.y"
    {printf("  >>modulating freq: %i\n", (yyvsp[(2) - (2)]));freq=(yyvsp[(2) - (2)]);}
    break;
...
/* Line 1455 of yacc.c  */
#line 82 "test.y"
    {printf("  >>carrier freq: %i\n",(yyvsp[(2) - (2)]));freq1=(yyvsp[(2) - (2)]);}
    break;
...
/* Line 1455 of yacc.c  */
#line 99 "test.y"
    {printf("  >>start freq: %i\n", (yyvsp[(2) - (2)]));start_freq=(yyvsp[(2) - (2)]);}
    break;
...
/* Line 1455 of yacc.c  */
#line 112 "test.y"
    {printf("  >>peak phase deviation: %i\n", (yyvsp[(2) - (2)]));deviat=(yyvsp[(2) - (2)]);}
    break;
